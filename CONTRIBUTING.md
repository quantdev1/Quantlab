Contributing to Quantlab Core
============================

The Quantlab Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Quantlab Core project, and is not to be
confused with overall Quantlab Network Protocol consensus changes.

Whether a pull request is merged into Quantlab Core rests with the project merge
...
Patches that change Quantlab consensus rules are considerably more involved than
...
Where a patch set proposes to change the Quantlab consensus, it must have been
...
The project leader is the release manager for each Quantlab Core release.
