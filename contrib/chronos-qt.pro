...
RESOURCES += src/qt/quantlab.qrc src/qt/quantlab_locale.qrc

TRANSLATIONS += src/qt/locale/quantlab_bg.ts \
                src/qt/locale/quantlab_de.ts \
                src/qt/locale/quantlab_en.ts \
                src/qt/locale/quantlab_es.ts \
                src/qt/locale/quantlab_fi.ts \
                src/qt/locale/quantlab_fr.ts \
                src/qt/locale/quantlab_it.ts \
                src/qt/locale/quantlab_ja.ts \
                src/qt/locale/quantlab_pl.ts \
                src/qt/locale/quantlab_pt.ts \
                src/qt/locale/quantlab_ru.ts \
                src/qt/locale/quantlab_sk.ts \
                src/qt/locale/quantlab_sv.ts \
                src/qt/locale/quantlab_vi.ts \
                src/qt/locale/quantlab_zh_CN.ts \
                src/qt/locale/quantlab_zh_TW.ts
