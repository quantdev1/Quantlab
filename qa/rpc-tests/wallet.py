...
#   c) node1 mines 32 blocks, so now node 0 has 60001qnt, node 1 has 4250qnt, node2 has none.
#   d) node0 sends 601 qnt to node2, in two transactions (301 qnt, then 300 qnt).
