                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Quantlab Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Quantlab address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and quantlab: URIs)"));
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zQNT"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Quantlab Core"), this);
    aboutAction->setStatusTip(tr("Show information about Quantlab Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Quantlab"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Quantlab addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Quantlab addresses"));
    ...
    openAction->setStatusTip(tr("Open a Quantlab: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Quantlab Core help message to get a list with possible Quantlab command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Quantlab Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Quantlab network", "", count));
}
...
{
    QString strTitle = tr("Quantlab Core"); // default title
