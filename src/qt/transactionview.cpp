 ...
 */
    ...
    typeWidget->addItem(tr("Received Qnt from zQnt"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zQnt"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zQnt));
