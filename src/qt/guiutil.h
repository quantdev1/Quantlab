...
/** Utility functions used by the Quantlab Qt UI.
 */
namespace GUIUtil
{
...
// Render Quantlab addresses in monospace font
...
// Parse "quantlab:" URI into recipient object, return true on successful parsing
