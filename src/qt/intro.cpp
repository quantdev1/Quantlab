...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Quantlab Core"),
     ...
     * override -datadir in the quantlab.conf file in the default data directory
     * (to be consistent with quantlabd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
