...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Quantlab server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Quantlab server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Quantlab features */
        {"quantlab", "masternode", &masternode, true, true, false},
        {"quantlab", "listmasternodes", &listmasternodes, true, true, false},
        {"quantlab", "getmasternodecount", &getmasternodecount, true, true, false},
        {"quantlab", "masternodeconnect", &masternodeconnect, true, true, false},
        {"quantlab", "masternodecurrent", &masternodecurrent, true, true, false},
        {"quantlab", "masternodedebug", &masternodedebug, true, true, false},
        {"quantlab", "startmasternode", &startmasternode, true, true, false},
        {"quantlab", "createmasternodekey", &createmasternodekey, true, true, false},
        {"quantlab", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"quantlab", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"quantlab", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"quantlab", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"quantlab", "getmasternodescores", &getmasternodescores, true, true, false},
        {"quantlab", "mnbudget", &mnbudget, true, true, false},
        {"quantlab", "preparebudget", &preparebudget, true, true, false},
        {"quantlab", "submitbudget", &submitbudget, true, true, false},
        {"quantlab", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"quantlab", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"quantlab", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"quantlab", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"quantlab", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"quantlab", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"quantlab", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"quantlab", "checkbudgets", &checkbudgets, true, true, false},
        {"quantlab", "mnsync", &mnsync, true, true, false},
        {"quantlab", "spork", &spork, true, true, false},
        {"quantlab", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"quantlab", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> quantlab-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:23002/\n";
}
