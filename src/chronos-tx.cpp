...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Quantlab Core quantlab-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  quantlab-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded quantlab transaction") + "\n" +
                               "  quantlab-tx [options] -create [commands]   " + _("Create hex-encoded quantlab transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded quantlab transaction
