...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("00000cba88c1275af3fab3931df72311866870f3ce81824fd4194604bf565857"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1536316952, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis.nNonce = 3318755;

        hashGenesisBlock = genesis.GetHash();
        assert(genesis.hashMerkleRoot == uint256("0x62a41e300aa94eda1989e9c31f5bd3c8b81e8d79d931c6b8715eba3c6c85e130"));
        assert(hashGenesisBlock == uint256("0x00000cba88c1275af3fab3931df72311866870f3ce81824fd4194604bf565857"));
...
public:
    CTestNetParams()
    {
        ...
        // Testnet quantlab BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 60 * 60; // Quantlab: 1 hour
        nTargetSpacing = 120;        // Quantlab: 2 min
