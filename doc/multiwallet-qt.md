...
In order to support loading of multiple wallets in quantlab-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is quantlab.cpp.
...
Changes to quantlab.cpp
----------------------
quantlab.cpp is the entry point into quantlab-qt, and as such, will require some minor modifications to provide hooks for
