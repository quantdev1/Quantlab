...
This mechanism has been integrated into Bitcore-Node-Quantlab which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Quantlab-Project/insight-api-quantlab#web-socket-api](https://github.com/Quantlab-Project/insight-api-quantlab#web-socket-api) 
* API: [https://github.com/Quantlab-Project/insight-api-quantlab#swifttx-transactions](https://github.com/Quantlab-Project/insight-api-quantlab#swifttx-transactions) 
...
By default, the Quantlab Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Quantlab Core daemon:
